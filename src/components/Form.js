...
const Form = props => {        
    return (   
        <form className="form" onSubmit={props.handleOnSubmit}>  
            {Object.keys(props.input).map(k => 
                <><input className="form-input" type="text" name={k} value={props.input.k} placeholder={props.input[k]} onChange={props.handleOnChange} required /> <br /></>
            )}           
